...
export default function InstitutionAnnouncementDetail() {
  const { user } = useAuth();
  ...
  const handleAnnouncementSelect = (announcementId) => {
    ...
    window.history.replaceState(null, '', `/${idOrName}/announcements/${announcementId}`);
  };
                ...
                <div className="card-body">
                  ...
                  <div className="mt-8 pt-6 border-t border-base-300">
                    <div className="flex items-center justify-between text-sm text-base-content/60">
                      ...
                      <span>ID: {currentAnnouncement._id}</span>
                    </div>
                  </div>
                </div>
              </div>
